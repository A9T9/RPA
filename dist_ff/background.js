...
var genGetTabIpc = function genGetTabIpc(tabIdName, purpose) {
  return function () {
    ...
    return _common_web_extension__WEBPACK_IMPORTED_MODULE_0___default.a.tabs.get(tabId).then(function (tab) {
      ...
      return Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().get(tab.id, timeout, before).catch(function (e) {
...
var getPlayTab = function getPlayTab(url) {
  ...
  return getTab(state.tabIds.toPlay).then(function (tab) {
    ...
    Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().disable(tab.id);
...
var bindEvents = function bindEvents() {
  ...
  _common_web_extension__WEBPACK_IMPORTED_MODULE_0___default.a.windows.onFocusChanged.addListener(function (windowId) {
    _common_web_extension__WEBPACK_IMPORTED_MODULE_0___default.a.tabs.query({ windowId: windowId, active: true }).then(function (tabs) {
      ...
      Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().get(tabs[0].id, 100).then(function (ipc) {
  ...
  _common_web_extension__WEBPACK_IMPORTED_MODULE_0___default.a.tabs.onActivated.addListener(function (activeInfo) {
    ...
    Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().get(activeInfo.tabId, 100).then(function (ipc) {
      return ipc.ask('TAB_ACTIVATED', {});
    }, function (e) {
      return 'Comment: ingore this error';
    });
      ...
      case _common_constant__WEBPACK_IMPORTED_MODULE_3__[/* APP_STATUS */ "a"].RECORDER:
        {
          ...
          Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().get(activeInfo.tabId, 5000)
...
var setInspectorTabId = function setInspectorTabId(tabId, shouldRemove, noNotify) {
  ...
  if (tabId) {
    ...
    if (state.tabIds.toInspect) {
      ...
      return Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().get(state.tabIds.toInspect).then(function (ipc) {
    ...
    case 'PANEL_RUN_COMMAND':
      {
        ...
        var runCommand = function runCommand(args, retryInfo) {
          return getPlayTabIpc().then(function (ipc) {
            ...
            var wait = function wait(res) {
              ...
              if (shouldResetIpc) {
                Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().disable(state.tabIds.toPlay);
              }
        ...
        var prepare = function prepare() {
          ...
          .catch(function (e) {
            ...
            return Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().get(tab.id, 100).then(function (ipc) {
            ...
            return p.then(function () {
              return Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().get(tab.id, 6000 * 10);
            }).then(function (ipc) {
    ...
    case 'PANEL_STOP_PLAYING':
      {
        ...
        return Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().get(state.tabIds.toPlay).then(function (ipc) {
    ...
    case 'CS_STORE_SCREENSHOT_IN_SELECTION':
      {
        ...
        return Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().get(tabId).then(function (ipc) {
      ...
      switch (state.status) {
        case _common_constant__WEBPACK_IMPORTED_MODULE_3__[/* APP_STATUS */ "a"].INSPECTOR:
          if (!state.tabIds.toInspect) {
            ...
            setTimeout(function () {
              Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().get(state.tabIds.toInspect).then(function (ipc) {
                return ipc.ask('SET_STATUS', {
    ...
    case 'CS_RECORD_ADD_COMMAND':
      {
        ...
        setTimeout(function () {
          Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().get(state.tabIds.toRecord).then(function (ipc) {
            return ipc.ask('SET_STATUS', {
              status: _common_constant__WEBPACK_IMPORTED_MODULE_3__[/* CONTENT_SCRIPT_STATUS */ "b"].RECORDING
            });
          });
    ...
    case 'CS_SELECT_WINDOW':
      {
        ...
        return pGetTabs.then(function (tabs) {
          ...
          return Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().get(tab.id, 10000).catch(function (e) {
            ...
            Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().get(oldTablId).then(function (ipc) {
              return ipc.ask('SET_STATUS', {
                status: _common_constant__WEBPACK_IMPORTED_MODULE_3__[/* CONTENT_SCRIPT_STATUS */ "b"].NORMAL
              });
            });
...
var initIPC = function initIPC() {
  Object(_common_ipc_ipc_bg_cs__WEBPACK_IMPORTED_MODULE_2__[/* bgInit */ "a"])(function (tabId, cuid, ipc) {
    ...
    Object(_common_ipc_ipc_cache__WEBPACK_IMPORTED_MODULE_15__[/* getIpcCache */ "a"])().set(tabId, ipc, cuid);
    ipc.onAsk(onRequest);
  });
};
