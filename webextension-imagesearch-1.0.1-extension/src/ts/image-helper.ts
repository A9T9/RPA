...
export class ImageHelper {
    ...
    /**
     * Gets a part of given image data as ImageData.
     * @param imageData Input image data.
     * @param region Region in input image data.
     * @returns Image data in given region as ImageData.
     */
    ...
    /**
     * Gets a part of given image data as data URL.
     * @param imageData Input image data.
     * @param region Region in input image data.
     * @returns Image data in given region as data URL.
     */
    static getImageDataRegionDataUrl(imageData: ImageData, region: Rect): string {
        const regionImageData = ImageHelper.getImageDataRegion(imageData, region);
        return ImageHelper.convertImageDataToDataUrl(regionImageData);
    }
}
