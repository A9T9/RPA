  ...
  render () {
    ...
    return decorate(
      ...
      >
        ...
        <div className="row-col command-col" style={{ width : columnWidths.cmd * tableWidth }} title={commandText(command.cmd)}>
        ...
        <div className="row-col op-col"  style={{ minWidth: columnWidths.opsFixed }}>
          {hasDescription ? (
            <Tooltip title={command.description}>
              <Button
                ...
                onClick={(e) => {
                  this.props.onToggleComment(e as any, command)
                  e.stopPropagation()
                }}
              > 
              </Button>
          ...
          <Button
            ...
            size="small"
            onClick={(e) => {
              this.props.onDuplicate(e as any, command)
              e.stopPropagation()
            }}
          >
            <PlusOutlined />
