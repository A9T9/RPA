...
import AnthropicService, {
  NO_ANTHROPIC_API_KEY_ERROR,
} from "@/services/ai/anthropic/anthropic.service";
...
class AITab extends React.Component<AiTabProps, AiTabAppState> {
  ...
  state: AiTabAppState = {
    model: this.props.config.model || ANTHROPIC_MODEL.COMPUTER_USE_MODEL_LATEST,
    temperature: this.props.config.temperature || 0.5,
    anthropicAPIKey: "",
  ...
  async onClickTestPrompt() {
    ...
    const anthropicService = new AnthropicService(
      this.props.config.anthropicAPIKey,
      this.state.model,
    ...
    return (
      <div className="ai-tab">
        <div className="row" style={{ marginBottom: "20px" }}>
          The AI commands feature is currently experimental/beta. It uses the
          Anthropic API. To enable the AI commands, please enter your (free)
        ...
        <div className="ai-settings-item">
          ...
          <Select
            options={Object.values(ANTHROPIC_MODEL).map((value) => ({
              value: value,
        ...
        <div className="ai-settings-item">
          ...
          <InputNumber
            ...
            max={1}
            onChange={(e) => {
              this.setState({ temperature: e ?? 0 });
            }}
          />
          <Button
            type="primary"
            onClick={() => {
              onConfigChange("temperature", this.state.temperature);
            }}
        ...
        <div className="ai-settings-item">
          ...
          <Input
            ...
            onChange={(e) =>
              onConfigChange("aiComputerUseMaxLoops", e.target.value)
            }
            placeholder=""
          />
        </div>
        ...
        <div className="ai-chat-in-sidebar">
          ...
          <Input
            type="text"
            value={
              this.props.config.aiChatSidebarPrompt ||
              "Describe what you see, in 10 words or less."
            }
            onChange={(e) => {
...
export default connect(
  ...
  (dispatch: Dispatch) =>
    bindActionCreators({ ...actions, ...simpleActions }, dispatch)
)(AITab);
